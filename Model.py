...
class PhoneBook:
    ...
    def new_contact(self, contact: list[str]):
        self.phonebook[self.next_id()] = Contact(contact.name, contact.phone, contact.comment)
    ...
    def change_contact(self, c_id: int, c_contact: list[str]):
        self.phonebook[c_id] = Contact(c_contact.name, c_contact.phone, c_contact.comment)
